...
function drawPlate(ctx, x, y, s, rot, color) {
  ...
  grad.addColorStop(1, Iso.shade(color, -18));
  ctx.beginPath();
  ctx.ellipse(0, 0, r, r * 0.72, 0, 0, Math.PI * 2);
  ctx.fillStyle = grad;
  ctx.fill();
  ctx.strokeStyle = Iso.shade(color, -50);
  ctx.lineWidth = 1.4;
  ctx.stroke();
  ctx.beginPath();
  ctx.ellipse(0, 0, r * 0.62, r * 0.44, 0, 0, Math.PI * 2);
  ctx.strokeStyle = Iso.shade(color, -35);
  ctx.lineWidth = 1;
  ctx.stroke();
  ctx.restore();
}
...
function drawBowl(ctx, x, y, s, rot) {
  ...
  ctx.fillStyle = grad;
  ctx.fill();
  ctx.strokeStyle = '#a5701f';
  ctx.lineWidth = 1.4;
  ctx.stroke();
  ctx.beginPath();
  ctx.ellipse(0, -r * 0.05, r * 0.55, r * 0.4, 0, 0, Math.PI * 2);
...
function drawPot(ctx, x, y, s, rot) {
  ...
  ctx.stroke();
  ctx.beginPath();
  ctx.ellipse(0, 0, r * 0.6, r * 0.46, 0, 0, Math.PI * 2);
...
function drawPan(ctx, x, y, s, rot) {
  ...
  ctx.stroke();
  ctx.beginPath();
  ctx.ellipse(0, 0, r * 0.58, r * 0.44, 0, 0, Math.PI * 2);
